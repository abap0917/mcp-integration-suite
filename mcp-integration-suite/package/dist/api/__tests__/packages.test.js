...
describe("Package Management API", () => {
    ...
    beforeAll(async () => {
        try {
            ...
            await (0, index_1.createPackage)(testPackageId, `Jest Test Package`, `Temporary package for Jest tests`);
            packageCreated = true;
    ...
    it("should retrieve a list of all packages", async () => {
        try {
            const packages = await (0, index_1.getPackages)();
            ...
            if (packageCreated) {
                ...
                const found = packages.some((pkg) => pkg.id === testPackageId);
    ...
    it("should retrieve a specific package by ID", async () => {
        ...
        try {
            const pkg = await (0, index_1.getPackage)(testPackageId);
