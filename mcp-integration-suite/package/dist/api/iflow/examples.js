...
const __1 = require("../..");
const resourceBasePath = path_1.default.resolve(__1.projPath, "./resources/examples/iflows/");
...
With a POST request without authentication
        `,
        _path: path_1.default.join(resourceBasePath, "if_http_server_to_http_request"),
    },
...
`,
        _path: path_1.default.join(resourceBasePath, "Replicate_product_inventory_info"),
    },
...
`,
        _path: path_1.default.join(resourceBasePath, "if_http_to_http_mapping")
    },
...
It uses a ProcessDirect Sender Channel so it can be called from other iflows
		`,
        _path: path_1.default.join(resourceBasePath, "if_google_get_oauth_token")
    },
...
The request/reply module then returns the response
		`,
        _path: path_1.default.join(resourceBasePath, "if_google_ads_campaigns")
    },
...
It then gives back the HTTP response via Request/reply module
		`,
        _path: path_1.default.join(resourceBasePath, 'if_fwd_google_request')
    }
};
