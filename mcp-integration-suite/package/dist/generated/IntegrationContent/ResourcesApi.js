...
class ResourcesApi {
    ...
    entityConstructor = Resources_1.Resources;
    requestBuilder() {
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                RESOURCE_TYPE: fieldBuilder.buildEdmTypeField('ResourceType', 'Edm.String', false),
                /**
                 * Static representation of the {@link referencedResourceType} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                REFERENCED_RESOURCE_TYPE: fieldBuilder.buildEdmTypeField('ReferencedResourceType', 'Edm.String', true),
                /**
                 * Static representation of the {@link resourceContent} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                RESOURCE_CONTENT: fieldBuilder.buildEdmTypeField('ResourceContent', 'Edm.Binary', true),
                ...this.navigationPropertyFields,
                /**
                 *
                 * All fields selector.
