...
exports.IntegrationPackagesRequestBuilder = void 0;
/*
 ...
 */
class IntegrationPackagesRequestBuilder extends odata_v2_1.RequestBuilder {
    /**
    ...
    delete(idOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, idOrEntity instanceof IntegrationPackages_1.IntegrationPackages
            ? idOrEntity
            : { Id: idOrEntity });
    }
}
exports.IntegrationPackagesRequestBuilder = IntegrationPackagesRequestBuilder;
//# sourceMappingURL=IntegrationPackagesRequestBuilder.js.map